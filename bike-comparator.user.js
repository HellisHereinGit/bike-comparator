...
// @connect *
// -----------------------------------------------------------------------
// AUTOACTUALIZACIÓN: sube este archivo a un repositorio público de GitHub
// (puede ser el mismo repo que bike-spec-extractor, como archivo aparte) y
// sustituye <TU-USUARIO-GITHUB> y <TU-REPO> por los reales. Con estas dos
// líneas, Tampermonkey comprueba solo si hay una versión más reciente y
// ofrece actualizar con un clic, en cualquier equipo donde esté instalado.
// -----------------------------------------------------------------------
// @updateURL https://raw.githubusercontent.com/<TU-USUARIO-GITHUB>/<TU-REPO>/main/bike-comparator.user.js
// @downloadURL https://raw.githubusercontent.com/<TU-USUARIO-GITHUB>/<TU-REPO>/main/bike-comparator.user.js
